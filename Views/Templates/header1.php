...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url; ?>">Geo <span>Billboard</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?php echo ($data['active'] == 'cars') ? 'active' : ''; ?>"><a href="<?php echo base_url . 'cars'; ?>" class="nav-link">Vallas Publicitarias</a></li>
