    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="<?php echo base_url; ?>">Geo Billboard</a>
                <a class="navbar-brand brand-logo-mini" href="<?php echo base_url; ?>">Geo Billboard</a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-vehiculo" aria-expanded="false" aria-controls="ui-vehiculo">
                            ...
                            <span class="menu-title">Vallas Publicitarias</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-vehiculo">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url . 'marcas'; ?>">Material</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url . 'tipos'; ?>">Tipos</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url . 'vehiculos'; ?>">Vallas</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-alquilar">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="<?php echo base_url . 'alquiler'; ?>">Alquileres</a></li>
