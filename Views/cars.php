					...
					<div class="car-wrap rounded ftco-animate">
						...
						<div class="text">
							...
							<div class="d-flex mb-3">
								...
								<p class="price ml-auto">Q<?php echo $car['precio_dia']; ?> <span>/mes</span></p>
							</div>
							...
							<a href="<?php echo base_url . 'cars/single/' . $car['id']; ?>" class="btn btn-secondary py-2 ml-1">Detalles</a></p>
						</div>
					</div>
				</div>
			<?php } ?>
