                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input id="select_vehiculo" class="form-control" type="text" name="select_vehiculo" placeholder="Buscar Valla" required>
                                        <label for="select_vehiculo">Buscar Valla <span class="text-danger fw-bold">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
...
<div class="modal fade" id="entrega" tabindex="-1" aria-labelledby="Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="Label">Entrega de la Valla</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
