...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    <li class="list-group-item"><b>Valla: </b> <?php echo $data['vehiculo']['tipo']; ?></li>
                    <li class="list-group-item"><b>Material: </b> <?php echo $data['vehiculo']['marca']; ?></li>
            ...
            <div class="col-md-6">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item"><b>Fecha Soicitud:</b> <?php echo $data['reserva']['f_recogida']; ?></li>
                    <li class="list-group-item"><b>Fecha Aprobación:</b> <?php echo $data['reserva']['f_entrega']; ?></li>
