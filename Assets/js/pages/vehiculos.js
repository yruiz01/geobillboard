...
function frmVehiculo() {
    document.getElementById("title").textContent = "Nueva Valla";
...
function btnEditarVeh(id) {
    document.getElementById("title").textContent = "Actualizar Valla";
...
function btnEliminarVeh(id) {
    Swal.fire({
        ...
        text: "La valla no se eliminará de forma permanente, solo cambiará el estado a inactivo!",
        icon: 'warning',
