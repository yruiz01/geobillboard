...
class Vehiculos extends Controller
{
        ...
        if (
            ...
            if ($id == "") {
                ...
                if ($data == "ok") {
                    ...
                    $msg = array('msg' => 'Valla registrada con éxito', 'icono' => 'success');
                } else if ($data == "existe") {
                    $msg = array('msg' => 'La valla ya existe', 'icono' => 'warning');
                } else {
                ...
                if ($data == "modificado") {
                    ...
                    $msg = array('msg' => 'Valla modificada', 'icono' => 'success');
                } else {
    ...
    public function eliminar(int $id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Valla dada de baja', 'icono' => 'success');
        } else {
            $msg = array('msg' => 'Error al eliminar la valla', 'icono' => 'error');
        }
        echo json_encode($msg, JSON_UNESCAPED_UNICODE);
        die();
    }
